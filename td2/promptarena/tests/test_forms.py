...
from promptarena.forms import  CreateContestForm, EnterContestNewStoryForm, EnterContestOldStoryForm, ContestStoryForm, EnterCritForm, AddJudgeForm
...
class CreateContestFormtTest(TestCase):
    ...
    def test_create_contest_form_valid(self):
        """validate the form"""
        self.form = CreateContestForm(data={"Title": "Contest Title",
